...
public final class Registries {
    ...
    public static final Registry<Block> BLOCK = Registry.create(new Identifier("block"));
    public static final Registry<Item> ITEMS = Registry.create(new Identifier("item"));
    public static final Registry<NoiseSettings> NOISE_SETTINGS = Registry.create(new Identifier("noise_settings"));
    ...
    public static void init() {
        ...
        Registries.REGISTRIES.register(Registries.BLOCK.id(), Registries.BLOCK);
