...
public final class Blocks {
    public static final Block AIR = Blocks.register("air", new Block(new Properties().noRendering().transparent()));
    public static final Block CAVE_AIR = Blocks.register("cave_air", new Block(new Properties().noRendering().transparent()));
