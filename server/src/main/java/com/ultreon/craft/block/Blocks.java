...
public final class Blocks {
    public static final Block AIR = Blocks.register("air", new Block(new Properties().noCollision().noRendering().transparent()));
    public static final Block CAVE_AIR = Blocks.register("cave_air", new Block(new Properties().noCollision().noRendering().transparent()));
    ...
    public static final Block VOIDGUARD = Blocks.register("voidguard", new Block(new Properties().unbreakable().effectiveTool(ToolType.PICKAXE).dropsItems(Items.DIRT)));
