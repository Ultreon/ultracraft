...
public class Button extends GuiComponent {
    ...
    public void render(Renderer renderer, int mouseX, int mouseY, float deltaTime) {
        ...
        renderer.texture(texture, x, y, 7, 7, u, v, 7, 7);
        renderer.texture(texture, x+7, y, this.width - 14, 7, 7 + u, v, 7, 7);
        renderer.texture(texture, x+ this.width -7, y, 7, 7, 14 + u, v, 7, 7);
        ...
        renderer.texture(texture, x, y + this.height - 7, 7, 7, u, 14 + v, 7, 7);
        renderer.texture(texture, x+7, y + this.height - 7, this.width - 14, 7, 7 + u, 14 + v, 7, 7);
        renderer.texture(texture, x+ this.width -7, y + this.height - 7, 7, 7, 14 + u, 14 + v, 7, 7);
