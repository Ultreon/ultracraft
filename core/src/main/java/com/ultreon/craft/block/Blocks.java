...
public final class Blocks extends UtilityClass {
    ...
    public static final Block GRASS_BLOCK = register("grass_block", new Block(new Properties().hardness(3F)));

    public static final Block DIRT = register("dirt", new Block(new Properties().hardness(3F)));
    public static final Block SAND = register("sand", new Block(new Properties().hardness(2.5F)));
