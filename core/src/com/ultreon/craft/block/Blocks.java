...
public final class Blocks extends UtilityClass {
    ...
    public static final Block SAND = register("stone", new Block(3, new CubeModel(UV.blockUV(2, 1))));
    public static final Block STONE = register("stone", new Block(3, new CubeModel(UV.blockUV(1, 0))));
    public static final Block WATER = register("water", new Block(4, new CubeModel(UV.blockUV(14, 13))));
