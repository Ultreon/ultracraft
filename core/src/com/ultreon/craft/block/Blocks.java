...
public final class Blocks extends UtilityClass {
    ...
    public static final RegistrySupplier<Block> DIRT = REGISTER.register("dirt", () -> new Block(2, new CubeModel(UV.blockUV(2, 0))));
    public static final RegistrySupplier<Block> SAND = REGISTER.register("stone", () -> new Block(3, new CubeModel(UV.blockUV(2, 1))));
    public static final RegistrySupplier<Block> STONE = REGISTER.register("stone", () -> new Block(3, new CubeModel(UV.blockUV(1, 0))));
    public static final RegistrySupplier<Block> WATER = REGISTER.register("water", () -> new Block(4, new CubeModel(UV.blockUV(14, 13))));
