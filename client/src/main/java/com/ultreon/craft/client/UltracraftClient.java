...
//            UltracraftClient.LOGGER.error("Failed to shut down " + disposable.getClass().getName(), throwable);
        }
    }
...
//            UltracraftClient.LOGGER.error("Failed to close " + disposable.getClass().getName(), throwable);
        }
    }
