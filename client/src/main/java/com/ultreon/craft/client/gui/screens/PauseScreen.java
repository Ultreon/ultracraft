...
public class PauseScreen extends Screen {
    ...
    public void init() {
        ...
        this.backToGameButton = this.add(new Button(this.width / 2 - 100, this.height / 3 - 25, 200, Language.translate("ultracraft.screen.pause.back_to_game"), this::resumeGame));
        this.optionsButton = this.add(new Button(this.width / 2 - 100, this.height / 3, 95, Language.translate("ultracraft.screen.title.options"), caller -> UltracraftClient.get().showScreen(new LanguageScreen())));
        this.exitWorldButton = this.add(new Button(this.width / 2 + 5, this.height / 3, 95, Language.translate("ultracraft.screen.pause.exit_world"), this::exitWorld));
