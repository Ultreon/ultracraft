...
//        this.transparentMaterial.set(FloatAttribute.createAlphaTest(0.02f));
    ...
    private void collectChunks(Array<Renderable> output, Pool<Renderable> renderablePool, List<ClientChunk> chunks, Array<ChunkPos> positions, LocalPlayer player, ChunkRenderRef ref) {
        for (var chunk : chunks) {
            ...
            if (chunk.shouldUpdate && !ref.chunkRendered && (chunk.solidMesh != null || chunk.transparentMesh != null) || (chunk.solidMesh != null || chunk.transparentMesh != null) && !ref.chunkRendered && chunk.getWorld().isChunkInvalidated(chunk)) {
                this.free(chunk);
            ...
            if (chunk.solidMesh == null || chunk.transparentMesh == null) continue;
