...
public class JsonModel implements BlockModel, ItemModel {
    public final Map<String, ElementID> textureElements;
    ...
    public JsonModel(RegistryKey<?> key, Map<String, ElementID> textureElements, List<JsonModelLoader.ModelElement> modelElements, boolean ambientOcclusion, JsonModelLoader.Display display) {
        this.key = key;
