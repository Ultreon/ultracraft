...
public class WorldShader extends DefaultShader {
    ...
    public static String createPrefix (final Renderable renderable, final Config config) {
        ...
        if (WorldShader.and(vertexMask, VertexAttributes.Usage.Normal) || WorldShader.and(vertexMask, VertexAttributes.Usage.Tangent | VertexAttributes.Usage.BiNormal)) {
    ...
    private static Attributes combineAttributes(final Renderable renderable) {
        WorldShader.tmpAttributes.clear();
